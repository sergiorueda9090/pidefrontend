...
import { filterFieldThunk, applyFilters, handleClearFilters } from '../../store/subcategoryStore/subcategoryThunks';
import { getAllThunks as getCategoriesThunks } from '../../store/categoryStore/categoryThunks';
import '../../styles/Filter.css';

const Filter = () => {
  const dispatch = useDispatch();
  const { filters } = useSelector(state => state.subcategoryStore);
