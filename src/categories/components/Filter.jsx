...
import { filterFieldThunk, applyFilters, handleClearFilters } from '../../store/categoryStore/categoryThunks';
import '../../styles/Filter.css';

const Filter = () => {
  const dispatch = useDispatch();
  const { filters } = useSelector(state => state.categoryStore);
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <CategoryOutlined sx={{ color: 'primary.main', fontSize: 28 }} />
                  </InputAdornment>
                ),
