...
import { handlePageChange, handlePageSizeChange } from '../../store/categoriesAtributostore/categoriesAtributoThunks';
import '../../styles/Pagination.css';

const Pagination = () => {
  const dispatch = useDispatch();

  const { paginado_info } = useSelector(state => state.categoriesAtributoStore);
