...
import { handlePageChange, handlePageSizeChange } from '../../store/attributeValueStore/attributeValueThunks';
import '../../styles/Pagination.css';

const Pagination = () => {
  const dispatch = useDispatch();

  const { paginado_info } = useSelector(state => state.attributeValueStore);
